...
function App() {
  ...
  const menu = [
  { id: "pessoas", label: "Pessoas", routes: "/pessoas"},
  { id: "transacoes", label: "Transações", routes: "/transacoes" },
  { id: "totais", label: "Totais", routes: "/totais"},
  ];
    ...
    <main className="min-h-screen bg-slate-100 text-slate-900 flex flex-row">
      ...
      <section className="flex-1 bg-slate-100">
        <div className="mx-auto max-w-5xl px-8 py-10 ">
          ...
          <p className="mt-1.5 text-sm text-blue-950">Adicione moradores da casa. Menores de idade só podem registrar despesas</p>
        </div>
        <div className="m-8 mr-8 ml-8 md:mx-auto max-w-5xl rounded-2xl bg-white p-6 shadow">
          ...
          <div className="p-6 pt-0">
            <form className="mt-6 flex flex-col gap-4 md:flex-row md:items-end" onSubmit={handleCriarPessoa}>
              ...
              <button
                  type="submit"
                  className="w-full items-end h-10 rounded-lg bg-blue-600 px-6 py-2 text-white transition hover:bg-blue-700 md:w-auto"
              >
                Cadastrar
              </button>
            </form>
